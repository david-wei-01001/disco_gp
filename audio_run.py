...
import torch
from disco_gp import DiscoGPAudioEncoder, Config, set_seed
import huggingface_hub, datasets

# --- Increase global Hugging Face timeouts and retries ---
huggingface_hub.constants.DEFAULT_TIMEOUT = 120  # seconds
datasets.config.DOWNLOAD_TIMEOUT = 120
datasets.config.DOWNLOAD_RETRIES = 20
...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------
    model_cfg = Config.from_tl("facebook/hubert-base-ls960", dtype=torch.bfloat16)
    ...
    model = DiscoGPAudioEncoder.from_pretrained(cfg)
